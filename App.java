package com.epam.software;

 import java.util.*;
 interface program{
	 void msg();
 }
public class Software implements program
{
	public void msg() {
...
class Chocolates extends Software{
...
class Candies extends Software
{
